...
public class A_EntityLifeCycleTests {
    ...
    public void 비영속성_테스트() {
        ...
        // foundMenu는 영속 내부에 있는 것이고 newMenu는 비영속에 있는 것이기 때문에
        // 주소 값이 같을 수가 없다.
        //then
        assertFalse(isTrue);
    }
    ...
    public void 영속성_객체_추가_테스트() {
        ...
        // menuToRegist가 persist로 1차 캐시에 저장되었기 때문에 foundMenu를 엔터티매니저로 find할 경우 1차 캐시에 있는
        // menuToRegist를 찾아오기 때문에 둘은 같다.
        //then
        assertTrue(isTrue);
    }
